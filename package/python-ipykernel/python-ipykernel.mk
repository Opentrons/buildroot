...
PYTHON_IPYKERNEL_DEPENDENCIES = python-comm python-ipython python-jupyter_client host-python-ipython host-python-jupyter_client python-stack-data host-python-backcall host-python-hatchling host-python-hatch-vcs
