...
PYTHON_IPYKERNEL_DEPENDENCIES = python-comm python-debugpy python-ipython python-jupyter_client host-python-ipython host-python-jupyter_client python-stack-data host-python-backcall
