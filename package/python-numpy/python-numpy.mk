...
# Prefer vendored Meson for configure + build (host and target)
...
# For ARM (OT-2), you also need longdouble_format via PYTHON_NUMPY_MESON_EXTRA_PROPERTIES, 
#because NumPy cannot run a target binary to detect it.
ifeq ($(BR2_arm),y)
