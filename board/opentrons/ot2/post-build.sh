...
python ./board/opentrons/ot2/write_version.py ${BINARIES_DIR}/opentrons-api-version.json ${BINARIES_DIR}/opentrons-update-server-version.json ${BINARIES_DIR}/opentrons-robot-server-version.json ${BINARIES_DIR}/opentrons-notify-server-version.json ${BINARIES_DIR}/opentrons-system-server-version.json ${BINARIES_DIR}/opentrons-server-utils-version.json ${BINARIES_DIR}/VERSION.json
